...
fun Application.configureRouting(usuarioService: IAuthService) {
    routing {
        /* Rutas sin autenticación por JWT:
        1- Login y registro
        2- Consulta conexión de backend */
        ...
        // Rutas con autenticacion por JWT
        authenticate("auth-jwt") {
            ...
            get("/reportes-cercanos") {
                ...
                val radio =
                    call.request.queryParameters["radio"]?.toDoubleOrNull() ?: 1000.0 // metros
                ...
                try {
                    val pipeline = listOf(
                        org.bson.Document(
                            "\$geoNear", org.bson.Document()
                                .append(
                                    "near", org.bson.Document("type", "Point")
